(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      elementStyle.appendChild(document.createTextNode("._app_4ncma_1 {\n	max-width: 1280px;\n	margin: 0 auto;\n	padding: 2rem;\n	text-align: center;\n	color: red;\n}"));
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.app, children: [
    "Компонент на React. Счетчик: ",
    count
  ] });
}
const arr = [];
arr.fill("Cnhjrsgsdgf", 1e3);
function foo(arr2 = []) {
...
const getRoot = () => clientExports.createRoot(document.querySelector("#react")).render(
